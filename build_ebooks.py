    ...
    <script>
        (function() {{
            ...
            const MOTIVATIONAL_BLURBS = {{
                ...
                early: [
                    "🌿 <strong>Stepping into The Margin:</strong> You're at {{depth}}% depth. Settle in and follow the dialogue!",
                    "🗝️ <strong>The Portal Opens:</strong> You've begun Session {{s}}. Follow the party's journey as the plot takes shape.",
                ...
                initial: [
                    "📖 <strong>Begin your reading journey:</strong> Scroll through the story blocks below to build your progress and join the Finisher Circle!",
                    "✨ <strong>Welcome to Session {{s}}:</strong> Start scrolling to track your reading depth against the readership base."
                ]
            }};

            function getMotivationalBlurb(depth, avgDropoff, isCompleted, cCount, rCount, sNum) {{
                let pool = [];
                if (isCompleted) {{
            ...
            function updateTelemetryUI() {{
                ...
                // Motivational Guidance Banner via rich blurb library
                if (motivationText && motivationBanner) {{
                    motivationText.innerHTML = getMotivationalBlurb(myDepth, avgDropoffPct, isCompleted, cCount, rCount, {session_num});
                    if (isCompleted) {{
